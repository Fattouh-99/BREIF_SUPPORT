...
var memoizedDecrypt = memoizeOne(
  (text) => _chunkJYRFFBKMcjs.decrypt.call(void 0, text),
  (a, b) => a[0] === b[0],
    ...
    (acc, valueIndex, index) => {
      ...
      switch (valueIndex) {
        ...
        case 252 /* NULL */:
          ...
          break;
        default:
          acc[flag2.key] = _optionalChain([flag2, 'access', _ => _.options, 'optionalAccess', _2 => _2[valueIndex], 'optionalAccess', _3 => _3.value]);
      }
      return acc;
    },
    {}
...
function getCachedValuePromise(headers, flagKey, entitiesKey) {
  const map = _optionalChain([evaluationCache, 'access', _4 => _4.get, 'call', _5 => _5(headers), 'optionalAccess', _6 => _6.get, 'call', _7 => _7(flagKey)]);
  if (!map)
    return void 0;
...
function getDecide(definition) {
  return function decide(params) {
    ...
    if (typeof _optionalChain([definition, 'access', _8 => _8.adapter, 'optionalAccess', _9 => _9.decide]) === "function") {
...
function getIdentify(definition) {
  return function identify(params) {
    ...
    if (typeof _optionalChain([definition, 'access', _10 => _10.adapter, 'optionalAccess', _11 => _11.identify]) === "function") {
...
function getRun(definition, decide) {
  return async function run(options) {
    ...
    const overrides = await getOverrides(
      _optionalChain([readonlyCookies, 'access', _12 => _12.get, 'call', _13 => _13("vercel-flag-overrides"), 'optionalAccess', _14 => _14.value])
    );
    ...
    if (cachedValue !== void 0) {
      _chunkJYRFFBKMcjs.setSpanAttribute.call(void 0, "method", "cached");
      const value = await cachedValue;
      return value;
    }
    if (overrides && overrides[definition.key] !== void 0) {
      _chunkJYRFFBKMcjs.setSpanAttribute.call(void 0, "method", "override");
      ...
      _chunkJYRFFBKMcjs.internalReportValue.call(void 0, definition.key, decision2, {
        reason: "override"
      });
      return decision2;
    }
    ...
    if (_optionalChain([definition, 'access', _15 => _15.config, 'optionalAccess', _16 => _16.reportValue]) !== false) {
      _chunkJYRFFBKMcjs.reportValue.call(void 0, definition.key, decision);
    }
    return decision;
  };
}
function getOrigin(definition) {
  ...
  if (typeof _optionalChain([definition, 'access', _17 => _17.adapter, 'optionalAccess', _18 => _18.origin]) === "function")
    return definition.adapter.origin(definition.key);
  return _optionalChain([definition, 'access', _19 => _19.adapter, 'optionalAccess', _20 => _20.origin]);
}
function flag(definition) {
  ...
  const flag2 = _chunkJYRFFBKMcjs.trace.call(void 0, 
    async (...args) => {
      _chunkJYRFFBKMcjs.setSpanAttribute.call(void 0, "method", "decided");
      if (typeof args[0] === "string" && Array.isArray(args[1])) {
        const [precomputedCode, precomputedGroup, secret] = args;
        if (precomputedCode && precomputedGroup) {
          _chunkJYRFFBKMcjs.setSpanAttribute.call(void 0, "method", "precomputed");
  ...
  flag2.origin = origin;
  flag2.options = _chunkAVMIIWOFcjs.normalizeOptions.call(void 0, definition.options);
  flag2.description = definition.description;
  flag2.identify = identify ? _chunkJYRFFBKMcjs.trace.call(void 0, identify, {
    isVerboseTrace: false,
    name: "identify",
    attributes: { key: definition.key }
  }) : identify;
  flag2.decide = _chunkJYRFFBKMcjs.trace.call(void 0, decide, {
    isVerboseTrace: false,
    name: "decide",
    attributes: { key: definition.key }
  });
  flag2.run = _chunkJYRFFBKMcjs.trace.call(void 0, run, {
    isVerboseTrace: false,
    name: "run",
    attributes: { key: definition.key }
  });
...
exports.combine = combine; exports.dedupe = dedupe; exports.deserialize = deserialize2; exports.evaluate = evaluate; exports.flag = flag; exports.generatePermutations = generatePermutations; exports.getPrecomputed = getPrecomputed; exports.getProviderData = getProviderData; exports.precompute = precompute; exports.serialize = serialize2;
