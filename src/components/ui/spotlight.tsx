...
export const Spotlight = ({
  ...
  gradientThird = "radial-gradient(50% 50% at 50% 50%, hsla(210, 100%, 85%, .1) 0, hsla(210, 100%, 45%, .06) 80%, transparent 100%)",
  translateY = -350,
  width = 680, // Increased width
  height = 1500, // Increased height
  smallWidth = 320, // Increased small width
  duration = 7,
  xOffset = 120, // Increased movement range
}: SpotlightProps = {}) => {
  return (
    <motion.div
      initial={{
